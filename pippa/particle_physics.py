"""Кандидатные matching-соотношения для параметров частиц в теории Pippa.

Геометрические формулы из раздела 11.3.1:
...
Значения вычисляются из формул точно, но сами соотношения являются гипотезами
matching-условий на указанном масштабе, а не доказанным выводом параметров
Стандартной модели. Феноменологические степенные формулы (массы лептонов с
параметром beta, нейтрино) вынесены в класс Phenomenology.
"""
...
# --- Кандидатные геометрические matching-соотношения ---------------------
